...
%===== DOCUMENT INFO =======================================================
\newcommand{\docTitleLineOne}{The APEX-DNN User Manual}    % First line of document title.
...
\newcommand{\cgvrhead}   % Right header for the Cognivue Document
  {\footnotesize{ \textit{NXP Semiconductors Confidential and Proprietary}}}
%===== CUSTOM COMMANDS END =================================================
...
1.0                                                             & Initial Revision                                                                                                         & Changyun (Nathan) Zhu & December 29, 2016                                              \\ \hline
1.1                                                             & RTM 1.0 Revision                                                                                                         & Changyun (Nathan) Zhu & June 21, 2017                                                  \\ \hline
\end{tabular}
\end{table}
