...
static void FIRE10_1ST_E1E3_nativekernel(void* pArgs)
{
   ...
   FIRE10_1ST_E1E3_INPUT_IMAGE.Init2D(0, (void*)lpIo->pBuf, lpIo->nd_size.width, lpIo->nd_size.height, lpIo->nd_span.height, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   //FIRE10_1ST_E1E3_INPUT_WEIGHT
   ACF_DataDesc FIRE10_1ST_E1E3_INPUT_WEIGHT;
   lpIo = (acf_io_info*)((int32_t)pArgs+1*sizeof(acf_io_info));
   FIRE10_1ST_E1E3_INPUT_WEIGHT.Init2D(0, (void*)lpIo->pBuf, lpIo->nd_size.width, lpIo->nd_size.height, lpIo->nd_span.height, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   //FIRE10_1ST_E1E3_INPUT_PARAMS
   ACF_DataDesc FIRE10_1ST_E1E3_INPUT_PARAMS;
   lpIo = (acf_io_info*)((int32_t)pArgs+2*sizeof(acf_io_info));
   FIRE10_1ST_E1E3_INPUT_PARAMS.Init2D(0, (void*)lpIo->pBuf, lpIo->nd_size.width, lpIo->nd_size.height, lpIo->nd_span.height, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   //FIRE10_1ST_E1E3_OUTPUT_E1
   ACF_DataDesc FIRE10_1ST_E1E3_OUTPUT_E1;
   lpIo = (acf_io_info*)((int32_t)pArgs+3*sizeof(acf_io_info));
   FIRE10_1ST_E1E3_OUTPUT_E1.Init2D(0, (void*)lpIo->pBuf, lpIo->nd_size.width, lpIo->nd_size.height, lpIo->nd_span.height, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);

   //FIRE10_1ST_E1E3_OUTPUT_E3
   ACF_DataDesc FIRE10_1ST_E1E3_OUTPUT_E3;
   lpIo = (acf_io_info*)((int32_t)pArgs+4*sizeof(acf_io_info));
   FIRE10_1ST_E1E3_OUTPUT_E3.Init2D(0, (void*)lpIo->pBuf, lpIo->nd_size.width, lpIo->nd_size.height, lpIo->nd_span.height, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);
