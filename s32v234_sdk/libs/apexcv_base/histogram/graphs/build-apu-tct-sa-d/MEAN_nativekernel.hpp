#ifndef _ACF_PROCESS_APU_MEAN_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_MEAN_NATIVE_KERNEL_WRAPPER
...
static void MEAN_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;
...
#endif //_ACF_PROCESS_APU_MEAN_NATIVE_KERNEL_WRAPPER
