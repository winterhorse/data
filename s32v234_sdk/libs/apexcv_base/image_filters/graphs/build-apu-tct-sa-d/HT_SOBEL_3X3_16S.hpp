...
public:
   ...
   int32_t Initialize()
   {
      ...
      if (!Initialized()) //initialization steps that only need to occur once
      {
         ...
         lRetVal |= mpApexTask->SetupHw("HT_SOBEL_3X3_16S",
                                        HT_SOBEL_3X3_16S_LOAD_SEGMENTS,
         ...
         SetApuStdioInfo(HT_SOBEL_3X3_16S_APEX_LOG_BUFFER, HT_SOBEL_3X3_16S_APEX_LOG_SIZE);
