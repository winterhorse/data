...
public:
   ...
   int32_t Initialize()
   {
      ...
      if (!Initialized()) //initialization steps that only need to occur once
      {
         ...
         lRetVal |= mpApexTask->SetupHw("RGB565_TO_RGB888X",
                                        RGB565_TO_RGB888X_LOAD_SEGMENTS,
         ...
         SetApuStdioInfo(RGB565_TO_RGB888X_APEX_LOG_BUFFER, RGB565_TO_RGB888X_APEX_LOG_SIZE);
