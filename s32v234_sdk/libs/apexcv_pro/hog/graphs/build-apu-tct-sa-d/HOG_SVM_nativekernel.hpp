#ifndef _ACF_PROCESS_APU_HOG_SVM_NATIVE_KERNEL_WRAPPER
#define _ACF_PROCESS_APU_HOG_SVM_NATIVE_KERNEL_WRAPPER
...
where:
   [0] corresponds to input 'IMAGE_BLOCK_HISTOGRAMS'
...
static void HOG_SVM_nativekernel(void* pArgs)
{
   acf_io_info* lpIo = 0;

   //IMAGE_BLOCK_HISTOGRAMS
   ACF_DataDesc IMAGE_BLOCK_HISTOGRAMS;
   lpIo = (acf_io_info*)((int32_t)pArgs+0*sizeof(acf_io_info));
   IMAGE_BLOCK_HISTOGRAMS.Init2D(0, (void*)lpIo->pBuf, lpIo->nd_size.width, lpIo->nd_size.height, lpIo->nd_span.height, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);
   ...
   HOG_SVM lProcess;
   lProcess.Initialize();
   lProcess.ConnectIO("IMAGE_BLOCK_HISTOGRAMS", IMAGE_BLOCK_HISTOGRAMS);
...
#endif //_ACF_PROCESS_APU_HOG_SVM_NATIVE_KERNEL_WRAPPER
