...
static void LAPLACIAN_PYRAMID_LAST_nativekernel(void* pArgs)
{
   ...
   OUTPUT_RECONSTRUCT.Init2D(0, (void*)lpIo->pBuf, lpIo->nd_size.width, lpIo->nd_size.height, lpIo->nd_span.height, lpIo->elementDataType, lpIo->elementDimX, lpIo->elementDimY);
