...
# use the default aarch64 cross compilers prefix
ENVBUILD=${SDK_ROOT}/envbuild.sh
. ${ENVBUILD} || exit 1
export CROSS_COMPILE_AARCH64_ELF_CC=${CROSS_COMPILE_AARCH64_ELF}gcc
export CROSS_COMPILE_AARCH64_ELF_CX=${CROSS_COMPILE_AARCH64_ELF}g++

COMMAND="$(${CROSS_COMPILE_AARCH64_ELF}gcc -print-file-name=)"
